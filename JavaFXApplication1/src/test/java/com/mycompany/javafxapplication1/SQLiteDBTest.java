...
public class SQLiteDBTest {
    ...
    @Test
    @DisplayName("saveSession/loadSession/clearSession round-trip user")
    ...
    @Test
    @DisplayName("insertLocalFile and getAllOwnedFiles returns expected data")
    ...
    @Test
    @DisplayName("updateLocalFile updates content and getLocalFileContent returns it")
    ...
    @Test
    @DisplayName("shareTo helpers return empty when null and updateShareTo persists")
    ...
    @Test
    @DisplayName("isFileExists returns true for active file and false after delete mark")
